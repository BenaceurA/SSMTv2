...
<body class="relative h-screen w-screen background-img">
    <div onclick="redirectTo('/')" class="flex flex-col justify-center h-full">
        <div class="flex justify-center w-auto mt-16">
            <div class="hidden xl:block rounded border-2 border-yellow-500">
