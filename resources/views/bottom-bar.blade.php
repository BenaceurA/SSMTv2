{{-- <div class="bottom-0 absolute text-white bg-black w-full bg-opacity-30" style="height: 7vh;font-family: 'Rubik','Roboto', sans-serif;">
    <div class="h-full flex justify-around mt-auto">
        <div class="flex flex-col sm:font-semibold text-xss md:text-sm lg:text-sm mt-auto mb-auto">
...
<div id="contact" class="hidden xl:flex text-white fixed bottom-0 w-full flex justify-center bg-opacity-70 bg-yellow-700 h-64 xl:h-8">
