<form class="w-full max-w-full md:max-w-5xl lg:max-w-5xl my-5 md:my-10 lg:my-10 mx-5 bg-opacity-90 bg-white p-5 md:p-10 lg:p-10 rounded-md" action="/api/postemploi" method="post" enctype="multipart/form-data">
            @csrf
            @if ($errors->any())
