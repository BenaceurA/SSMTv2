    ...
    @csrf
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center">
          <input onclick="check()" value="false" id="remember_me" name="remember_me" type="checkbox" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
...
function check(){
let e = document.getElementById("remember_me");
let f = document.getElementById("remember");
e.checked ? 
f.value = true : 
f.value = false;
}
